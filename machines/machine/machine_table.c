...
const machine_t machines[] = {
       ...
       VT82C42N. */
    {
        ...
        .snd_device               = NULL,
        .net_device               = NULL,
        .aliases                  = { "Soltek SL-56H1", "Soltek SL-56H2", "" }
    },
    ...
    /* Has the AMIKey-2 ('H') KBC firmware. */
    {
        ...
        .internal_name     = "ga686fx",
        .type              = MACHINE_TYPE_SOCKET8,
        .chipset           = MACHINE_CHIPSET_INTEL_440FX,
        .init              = machine_at_ga686fx_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* Has a SM(S)C FDC37M60x Super I/O chip with on-chip KBC with 
       AMIKey-2 KBC firmware. */
    {
        .name              = "[i440BX] Biostar M6TBA",
        .internal_name     = "m6tba",
        .type              = MACHINE_TYPE_SLOT1,
        .chipset           = MACHINE_CHIPSET_INTEL_440BX,
        .init              = machine_at_m6tba_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* Has a Winbond W83977EF Super I/O chip with on-chip KBC with AMIKey-2 (updated 'H') KBC firmware. */
    {
    ...
    /* Has a Winbond W83977TF Super I/O chip with on-chip KBC with AMIKey-2 KBC
       firmware. */
    {
        .name              = "[i440LX] Gigabyte GA-6LA7",
        .internal_name     = "ga6la7",
        .type              = MACHINE_TYPE_SOCKET370,
        .chipset           = MACHINE_CHIPSET_INTEL_440LX,
        .init              = machine_at_ga6la7_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* Has a Winbond W83977EF Super I/O chip with on-chip KBC with AMIKey-2 KBC
       firmware. */
    {
        .name              = "[i440BX] Gigabyte GA-6BX7",
        .internal_name     = "ga6bx7",
        .type              = MACHINE_TYPE_SOCKET370,
        .chipset           = MACHINE_CHIPSET_INTEL_440BX,
        .init              = machine_at_ga6bx7_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
       ...
       firmware. */
    {
        ...
        .snd_device               = &stac9721_device,
        .net_device               = NULL,
        .aliases                  = { "Amptron Vega V6941", "Fujitsu-Siemens Euroline 850", "" }
    },
    /* Has the VIA VT82C686B southbridge with on-chip KBC identical to the VIA
       VT82C42N. */
    {
