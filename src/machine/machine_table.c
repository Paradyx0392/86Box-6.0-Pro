...
const machine_t machines[] = {
    ...
    /* Has the VIA VT82C686A southbridge with on-chip KBC identical to the VIA
       VT82C42N. */
    {
        .name              = "[VIA Apollo Pro 133A] ABIT AB-VH6",
        .internal_name     = "vh6",
        .type              = MACHINE_TYPE_SOCKET370,
        .chipset           = MACHINE_CHIPSET_VIA_APOLLO_PRO_133A,
        .init              = machine_at_vh6_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
       ...
       firmware. */
    {
        ...
        .bus_flags = MACHINE_PS2_A97 | MACHINE_BUS_USB,
        .flags     = MACHINE_IDE_DUAL | MACHINE_AG | MACHINE_APM | MACHINE_ACPI | MACHINE_GAMEPORT | MACHINE_USB | MACHINE_SOUND,
        .ram       = {
            .min  = 8192,
            .max  = 1572864,
            .step = 8192
