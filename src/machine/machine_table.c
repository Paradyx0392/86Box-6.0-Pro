...
const machine_t machines[] = {
       ...
       Command 0xA0 copyright string: (C)1994 AMI . */
    {
        ...
        .net_device               = NULL,
        .aliases                  = { "Intel Morrison32", "HP Morrison", "HP Pavilion 50x0/70xx", "Zenith Data Systems Z-Station GT", "AST Advantage! 8100P", "" }
    },
    /* According to tests from real hardware: This has AMI MegaKey KBC firmware on the
       PC87306 Super I/O chip, command 0xA1 returns '5'.
       Command 0xA0 copyright string: (C)1994 AMI . */
    ...
    /* This has an AMIKey-2, which is type 'H'. */
    {
        .name              = "[i430FX] MSI MS-5119 and MS-5120",
        ...
        .snd_device               = NULL,
        .net_device               = NULL,
        .aliases                  = { "MSI MS-5119", "MSI MS-5120", "" }
    },
    ...
    /* Has a SM(S)C FDC37C935 Super I/O chip with on-chip KBC with Phoenix
       MultiKey/42 (version 1.38) KBC firmware. */
    {
        .name              = "[i430VX] Packard Bell PB770",
        .internal_name     = "pb770",
        .type              = MACHINE_TYPE_SOCKET7,
        .chipset           = MACHINE_CHIPSET_INTEL_430VX,
        .init              = machine_at_pb770_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* This has the AMIKey 'H' firmware (AMIKey-2). Includes W83877F. */
    {
        .name              = "[i430VX] Soltek SL-55A5",
        .internal_name     = "55a5",
        .type              = MACHINE_TYPE_SOCKET7,
        .chipset           = MACHINE_CHIPSET_INTEL_430VX,
        .init              = machine_at_55a5_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
        ...
        .snd_device               = NULL,
        .net_device               = NULL,
        .aliases                  = { "Soltek SL-55A2", "" }
    },

    /* 430TX */
    /* This has the AMIKey KBC firmware. Featuring W83977TF */
    {
        .name              = "[i430TX] ABIT AB-TX5",
        .internal_name     = "tx5",
        .type              = MACHINE_TYPE_SOCKET7,
        .chipset           = MACHINE_CHIPSET_INTEL_430TX,
        .init              = machine_at_tx5_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    {
        .name              = "[SiS 5591] ASUS SP98AGP-X",
        .internal_name     = "sp98agpx",
        .type              = MACHINE_TYPE_SOCKET7,
        .chipset           = MACHINE_CHIPSET_SIS_5591,
        .init              = machine_at_sp98agpx_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* Has the ALi M1543C southbridge with on-chip KBC. */
    {
        .name              = "[ALi ALADDiN V] BCM VP1541 and VP1543",
        .internal_name     = "vp1541",
        .type              = MACHINE_TYPE_SOCKETS7,
        .chipset           = MACHINE_CHIPSET_ALI_ALADDIN_V,
        .init              = machine_at_vp1541_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* Has the VIA VT82C586B southbridge with on-chip KBC identical to the VIA
       VT82C42N. */
    {
        .name              = "[VIA MVP3] Soltek SL-54U5",
        .internal_name     = "sl54u5",
        .type              = MACHINE_TYPE_SOCKETS7,
        .chipset           = MACHINE_CHIPSET_VIA_APOLLO_MVP3,
        .init              = machine_at_sl54u5_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
        ...
        .gpio                     = 0xffffffff,
        .gpio_acpi                = 0xffffffff,
        .device                   = &sl54u5_device,
        .kbd_device               = NULL,
        .fdc_device               = NULL,
        .vid_device               = NULL,
        .snd_device               = NULL,
        .net_device               = NULL,
        .aliases                  = { "Soltek SL-54U1", "Magic-Pro/Famous Technology MP-VIP4", "Addonics A55MVP3/AT", "" }
    },
    /* Has the VIA VT82C586B southbridge with on-chip KBC identical to the VIA
       VT82C42N. */
    {
        .name              = "[VIA MVP3] Soltek SL-56D5",
        .internal_name     = "sl56d5",
        .type              = MACHINE_TYPE_SOCKETS7,
        .chipset           = MACHINE_CHIPSET_VIA_APOLLO_MVP3,
        .init              = machine_at_sl56d5_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
        ...
        .gpio                     = 0xffffffff,
        .gpio_acpi                = 0xffffffff,
        .device                   = &sl56d5_device,
        .kbd_device               = NULL,
        .fdc_device               = NULL,
        .vid_device               = NULL,
        .snd_device               = NULL,
        .net_device               = NULL,
        .aliases                  = { "Soltek SL-56D1", "Magic-Pro/Famous Technology MP-VIP4-X", "" }
    },
    /* Has the VIA VT82C686A southbridge with on-chip KBC identical to the VIA
       VT82C42N. */
    {
        .name              = "[VIA MVP3] Soltek SL-56H5",
        .internal_name     = "sl56h5",
        .type              = MACHINE_TYPE_SOCKETS7,
        .chipset           = MACHINE_CHIPSET_VIA_APOLLO_MVP3,
        .init              = machine_at_sl56h5_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
        ...
        .snd_device               = NULL,
        .net_device               = NULL,
        .aliases                  = { "Soltek SL-56H2", "Soltek SL-56H1", "" }
    },
    /* Has the VIA VT82C586B southbridge with on-chip KBC
       and SM(S)C FDC37C669 Super I/O Chip. */
    {
        .name              = "[VIA MVP3] Soyo 5EMA+",
        .internal_name     = "5emaplus",
        .type              = MACHINE_TYPE_SOCKETS7,
        .chipset           = MACHINE_CHIPSET_VIA_APOLLO_MVP3,
        .init              = machine_at_5emaplus_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* Has the AMIKey-2 ('H') KBC firmware. */
    {
        .name              = "[i440FX] Gigabyte GA-686FX",
        .internal_name     = "686fx",
        .type              = MACHINE_TYPE_SOCKET8,
        .chipset           = MACHINE_CHIPSET_INTEL_440FX,
        .init              = machine_at_686fx_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* Has a Winbond W83977TF Super I/O chip with on-chip KBC with AMIKey-2 KBC
       firmware. */
    {
        .name              = "[i440LX] AIR P6LXI",
        .internal_name     = "p6lxi",
        .type              = MACHINE_TYPE_SLOT1,
        .chipset           = MACHINE_CHIPSET_INTEL_440LX,
        .init              = machine_at_p6lxi_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* Has a Winbond W83977TF Super I/O chip with on-chip KBC with AMIKey-2 KBC
       firmware. */
    {
        .name              = "[i440EX] MSI MS-6122",
        .internal_name     = "ms6122",
        .type              = MACHINE_TYPE_SLOT1,
        .chipset           = MACHINE_CHIPSET_INTEL_440EX,
        .init              = machine_at_ms6122_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
        ...
        .gpio                     = 0xffffffff,
        .gpio_acpi                = 0xffffffff,
        .device                   = &ms6122_device,
        .kbd_device               = NULL,
        .fdc_device               = NULL,
        .vid_device               = NULL,
        .snd_device               = &ymf715_onboard_device,
        .net_device               = NULL,
        .aliases                  = { "LG IBM Multinet x7F", "" }
    },
    ...
    /* Has a Winbond W83977TF Super I/O chip with on-chip KBC with AMIKey-2 KBC firmware. */
    {
        .name              = "[i440BX] MSI MS-6156",
        .internal_name     = "ms6156",
        .type              = MACHINE_TYPE_SLOT1,
        .chipset           = MACHINE_CHIPSET_INTEL_440BX,
        .init              = machine_at_ms6156_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* Has a Winbond W83977EF Super I/O chip with on-chip KBC with AMIKey-2 KBC
       firmware. */
    {
        .name              = "[i440BX] Soltek SL-65EB",
        .internal_name     = "65eb",
        .type              = MACHINE_TYPE_SOCKET370,
        .chipset           = MACHINE_CHIPSET_INTEL_440BX,
        .init              = machine_at_65eb_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* Has a Winbond W83977TF Super I/O chip with on-chip KBC with AMIKey-2 KBC
       firmware. */
    {
        .name              = "[i440ZX] Soltek SL-65F+",
        .internal_name     = "sl65fplus",
        .type              = MACHINE_TYPE_SOCKET370,
        .chipset           = MACHINE_CHIPSET_INTEL_440ZX,
        .init              = machine_at_sl65fplus_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    {
        .name              = "[VIA Apollo Pro 133] Biostar M6VCH",
        .internal_name     = "m6vch",
        .type              = MACHINE_TYPE_SOCKET370,
        .chipset           = MACHINE_CHIPSET_VIA_APOLLO_PRO_133,
        .init              = machine_at_m6vch_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* Has the VIA VT82C686A southbridge with on-chip KBC identical to the VIA
       VT82C42N. */
    {
        .name              = "[VIA Apollo Pro 133A] Biostar M6VCG",
        .internal_name     = "m6vcg",
        .type              = MACHINE_TYPE_SOCKET370,
        .chipset           = MACHINE_CHIPSET_VIA_APOLLO_PRO_133A,
        .init              = machine_at_m6vcg_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
        ...
        .snd_device               = &stac9721_device,
        .net_device               = NULL,
        .aliases                  = { "Amptron Vega V6941", "Fujitsu-Siemens Euroline 850", "Pine Technology PT-694X", "" }
    },
    /* Has a Winbond W83977EF Super I/O chip with on-chip KBC with AMIKey-2 KBC
       firmware. */
    {
        .name              = "[VIA Apollo Pro 133A] ECS P6VAP-A+",
        .internal_name     = "p6vap",
        .type              = MACHINE_TYPE_SOCKET370,
        .chipset           = MACHINE_CHIPSET_VIA_APOLLO_PRO_133A,
        .init              = machine_at_p6vap_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
        ...
        .snd_device               = &cmi8738_onboard_device,
        .net_device               = NULL,
        .aliases                  = { "Matsonic MS-7157C", "Houston M865FC", "" }
    },
    /* Has the VIA VT82C686B southbridge with on-chip KBC identical to the VIA
       VT82C42N. */
    {
    ...
    /* Has the VIA VT82C686B southbridge with on-chip KBC identical to the VIA
       VT82C42N. */
    {
        .name              = "[VIA Apollo Pro 133A] Soltek SL-65KV2",
        .internal_name     = "sl65kv2",
        .type              = MACHINE_TYPE_SOCKET370,
        .chipset           = MACHINE_CHIPSET_VIA_APOLLO_PRO_133A,
        .init              = machine_at_sl65kv2_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
        ...
        .net_device               = NULL,
        .aliases                  = { "Formosa Industrial CV133A", "" }
    },
