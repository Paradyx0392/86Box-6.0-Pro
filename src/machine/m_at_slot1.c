...
int
machine_at_m6tlc_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/m6tlc/TLC0306B.BIN",
                           0x000c0000, 262144, 0);
...
machine_at_prm0076i_init(const machine_t *model)
{
    ...
    ret = bios_load_linear("roms/machines/prm0076i/prm76v315.bin",
                           0x000e0000, 131072, 0);
...
int
machine_at_p6lxaplus_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/p6lxaplus/p6lxap33a.bin",
                           0x000c0000, 262144, 0);
...
static const device_config_t ficvl601_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "ficvl601a",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "AMIBIOS 6 (071595) - Revision IV616",
                .internal_name = "ficvl601a",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ficvl601/IV616.rom", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.15IV10",
                .internal_name = "ficvl601w",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ficvl601/IV1510.bin", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t ficvl601_device = {
    .name          = "FIC VL-601",
    .internal_name = "ficvl601",
    .flags         = 0,
    .local         = 0,
    .init          = NULL,
    .close         = NULL,
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = ficvl601_config
};

int
machine_at_ficvl601_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
/* i440BX */
int
machine_at_atc6240_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/atc6240/6240b305.bin",
                           0x000c0000, 262144, 0);
        ...
        .bios           = {
            {
              ...
              .local         = 0,
              .size          = 262144,
              .files         = { "roms/machines/p2xbl/pbbzk.bin", "" }
            },
            {
              .name          = "Phoenix-AwardBIOS v6.00PG - Revision 02/23/2004 (by eSupport)",
...
int
machine_at_p6bxaplus_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/p6bxaplus/BXAP56.BIN",
                           0x000c0000, 262144, 0);
...
int
machine_at_epbx3_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/epbx3/bxc00920.bin",
                           0x000c0000, 262144, 0);
...
int
machine_at_ga6a_init(const machine_t *model)
{
    int ret;
...
static const device_config_t ms6156_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "ms6156w",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                ...
                .internal_name = "ms6156a",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ms6156/A656MS11.ROM", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.6",
                .internal_name = "ms6156w",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ms6156/W6156IMS.160", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t ms6156_device = {
    .name          = "MSI MS-6156",
    .internal_name = "ms6156",
    .flags         = 0,
    .local         = 0,
    .init          = NULL,
    .close         = NULL,
...
int
machine_at_r657e_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/r657e/r657e003.bin",
                           0x000e0000, 131072, 0);
...
int
machine_at_sy6ba_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/sy6ba/6ba-2b1.bin",
                           0x000c0000, 262144, 0);
...
static const device_config_t ms6156zx_config[] = {
    // clang-format off
    {
        ...
        .bios           = {
            {
                .name          = "AMIBIOS 6 (071595) - Revision 1.61 (Packard Bell PB911)",
                .internal_name = "ms6156zxap",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
            ...
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.3 (Fujitsu T-Bird GS160X PIII450)",
                .internal_name = "ms6156zxwf",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
...
int
machine_at_sl67ez_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/sl67ez/67ezb-r8.bin",
                           0x000c0000, 262144, 0);
...
int
machine_at_ga6vx_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/ga6vx/6VX.16",
                           0x000c0000, 262144, 0);
...
int
machine_at_67ev1_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/67ev1/67ev-v7.bin",
                           0x000c0000, 262144, 0);
...
int
machine_at_sl67kv_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/sl67kv/67kv-f81.bin",
                           0x000c0000, 262144, 0);
...
int
machine_at_ga6sx_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/ga6sx/6sx.10",
                           0x000c0000, 262144, 0);
